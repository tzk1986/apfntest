...
class AfpnTest(seldom.TestCase):
    ...
    def test_Afpn_002_1(self):
        ...
        self.assertStatusOk()
        s.find(
            "#app > section > section > section > main > div.main > div.s-card > div > div.search_option_left.s-gap-6-15 > div.s-gap-6-10.s-g-l-0 > button"    
        ).click()
        s.sleep()
        # 列表查询
        r = requests.post(
    ...
    def test_Afpn_002_2(self):
        ...
        self.assertStatusOk()
        s.find(
            "#app > section > section > section > main > div.main > div.s-card > div > div > div.s-gap-6-10.s-g-l-0 > button"
        ).click()
        s.sleep()
        # 列表查询
        r = requests.post(
